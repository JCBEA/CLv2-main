...
export const iconNifyColored = ["devicon:facebook", "skill-icons:instagram", "skill-icons:gmail-light"];

// uncomment nalang if trip yung walang color na icons
export const iconNifyNonColored = ["iconoir:facebook-tag", "ph:instagram-logo-light", "fluent:mail-28-regular"];