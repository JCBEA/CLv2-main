  ...
  return (
      ...
      <div className="w-full md:h-[70dvh] h-fit md:py-0 py-12 bg-shade-1 rounded-3xl">
        <div className="w-full h-full flex flex-col gap-12 md:justify-center justify-evenly md:items-start items-center md:pl-16 px-2">
          ...
          <div className="md:w-fit w-full flex flex-row md:justify-center justify-evenly items-center md:gap-12 font-semibold">
            <button className="bg-primary-2 text-secondary-1 w-32 py-2 rounded-full uppercase">join</button>
            <button className="bg-secondary-1 text-primary-2 w-32 py-2 rounded-full uppercase" >explore</button>
          </div>
        </div>
      </div>
