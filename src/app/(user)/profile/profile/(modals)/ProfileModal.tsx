                                        ...
                                        <div className="flex md:w-fit w-full items-center">
                                            ...
                                            >
                                                ...
                                                <div className="md:w-[20rem] w-full  flex flex-col gap-2 text-base md:p-0 p-4">
                                                    ...
                                                    <div className="w-full flex flex-col gap-1">
                                                        <label className="ml-4" htmlFor="bday">Birthdate</label>
                                                        <input
                                                            type="date"
                                                            name="bday"
                                                            value={formData.bday}
                                            ...
                                            >
                                                <div className="w-full flex flex-col justify-center items-center gap-4 text-base md:h-44 h-fit">
                                                    ...
                                                    <div className="w-full flex md:flex-row flex-col justify-center items-center gap-4 text-base h-fit">
                                                        <div className="w-full flex flex-col gap-1">
                                                            <label className="ml-4 capitalize" htmlFor="facebook">Facebook link</label>
                                                            <input
                                                                type="facebook"
                                                                name="facebook"
                                                        ...
                                                        <div className="w-full flex flex-col gap-1">
                                                            <label className="ml-4 capitalize" htmlFor="instagram">instragram link</label>
                                                            <input
                                                                type="instagram"
                                                                name="instagram"
                                                        ...
                                                        <div className="w-full flex flex-col gap-1">
                                                            <label className="ml-4 capitalize" htmlFor="email">Email adress</label>
                                                            <input
                                                                type="email"
                                                                name="email"
                                                    ...
                                                    <div className="w-full flex md:flex-row flex-col justify-center items-center gap-4 text-base h-fit">
                                                        <div className="w-full flex flex-col gap-1">
                                                            <label className="ml-4 capitalize" htmlFor="creative_field">Creative field</label>
                                                            <input
                                                                type="creative_field"
                                                                name="creative_field"
                                                        ...
                                                        <div className="w-full flex flex-col gap-1">
                                                            <label className="ml-4 capitalize" htmlFor="mobileNo">Mobile No.</label>
                                                            <input
                                                                type="number"
                                                                name="mobileNo"
                                                                value={formData.mobileNo}
                                                                onChange={handleInputChange}
                                                                className="w-full [appearance:textfield] [&::-webkit-outer-spin-button]:appearance-none [&::-webkit-inner-spin-button]:appearance-none md:py-2.5 py-4 border rounded-xl px-4 outline-none" placeholder="Contact Number" />
                                                        </div>
                                                        <div className="w-full flex flex-col gap-1">
                                                            <label className="ml-4 capitalize" htmlFor="portfolioLink">Portfolio Link</label>
                                                            <input
                                                                type="portfolioLink"
                                                                name="portfolioLink"
