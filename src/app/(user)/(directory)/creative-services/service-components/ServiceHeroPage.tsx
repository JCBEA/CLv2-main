...
export const ServiceHeroPage = () => {
    return (
        <div className="w-full h-dvh">
            <div className="w-full pt-[20dvh] flex flex-col gap-5 max-w-[70%] mx-auto border border-black">
                <div className="w-full relative border border-black flex justify-start items-start">
                ...
                <div className="w-full flex">
                    <div className="w-full max-w-[45%] flex flex-col gap-6 justify-start items-start border border-black">
                    ...
                    <div className="w-full min-h-fit border border-black relative">
